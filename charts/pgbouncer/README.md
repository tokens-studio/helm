...
```bash
helm repo add tokens-studio https://tokens-studio.github.io/helm
helm install my-pgbouncer tokens-studio/pgbouncer
```
...
| image.repository | string | `"bitnami/pgbouncer-docker"` | Container image repository |
...
| probes | object | `{"liveness":{"failureThreshold":3,"initialDelaySeconds":60,"periodSeconds":10,"successThreshold":1,"timeoutSeconds":5},"readiness":{"failureThreshold":3,"initialDelaySeconds":10,"periodSeconds":5,"successThreshold":1,"timeoutSeconds":3},"startup":{"failureThreshold":30,"initialDelaySeconds":5,"periodSeconds":5,"successThreshold":1,"timeoutSeconds":3}}` | Probe configuration |
